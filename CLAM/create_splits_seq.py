...
parser.add_argument('--csv_path', type=str, default= 'dataset_csv/tumor_subtyping_dummy_clean.csv',
                    help='Path to the dataset CSV file (default: dataset_csv/tumor_subtyping_dummy_clean.csv)')
...
if __name__ == '__main__':
    ...
    for lf in label_fracs:
        split_dir = os.path.join(args.split_dir, str(args.task) + '_{}'.format(int(lf * 100)))
